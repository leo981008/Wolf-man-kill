...
ROLE_STRATEGIES = {
    "平民": {
        ...
        "voting_guide": "投票優先考量：(1) 被預言家查殺的玩家 > (2) 發言邏輯矛盾最多的玩家 > (3) 划水不表態的玩家。如果完全沒把握，跟隨預言家或多數好人歸票。"
    },
    "狼人": {
    ...
    "預言家": {
        ...
        """,
        "phase_guide": {
            "early": "Day 1 是預言家最關鍵的一天。必須第一時間起跳報驗人結果。如果有人對跳，立刻攻擊對跳者的漏洞。要求場上好人站邊。如果你查到金水，拉票保他。",
            "mid": "每晚驗人後第一時間報結果。用累積的驗人資訊建立邏輯鏈，帶領好人歸票。告訴大家今晚的驗人計畫。如果你被毒或被刀，你留下的驗人紀錄就是好人的遺產。",
            "late": "如果你還活著，代表守衛/女巫保護得好。用所有驗人結果做最終推理，直接點狼歸票。殘局時你的每一句話都至關重要。"
        },
        "reasoning_guide": """
        分析框架：
        1. 我查過誰？結果是什麼？（列出所有驗人結果）
        2. 場上有沒有人對跳預言家？他的發言有什麼漏洞？
        3. 還有哪些人沒被驗過？誰最可疑？
        4. 今晚我應該驗誰才能最大化資訊量？
        """,
        "action_guide": "優先查驗發言有爭議的玩家，或你覺得看不清身分的玩家（「深水狼」）。",
        "voting_guide": "投票策略：(1) 你查殺的玩家必須推出去 > (2) 如果有人對跳你，全力推對跳者 > (3) 發言邏輯最差的未驗玩家。預言家的歸票能力是好人最強的武器。"
    },
    "女巫": {
        ...
        """,
        "phase_guide": {
            "early": "第一天通常隱藏身分。如果你救了人，可以選擇報銀水（告訴誰被救）或暫時隱藏。觀察場上，不要急著跳身分，除非預言家需要你站邊。",
            "mid": "中期你的毒藥是好人的王牌。如果預言家查殺了人且投票推不動，你可以考慮毒殺。發言時可以暗示你還有藥，威懾狼人。如果預言家死了，你可以接替帶隊。",
            "late": "殘局時如果還有毒藥，你的一票加一毒等於兩票。全場壓力最大。如果能確定狼人身分，直接毒殺不要猶豫。"
        },
        "reasoning_guide": """
        分析框架：
        1. 我的解藥/毒藥使用狀態？（哪些已用，哪些還有）
        2. 如果我救了人，被救的人後續表現如何？是否值得信任？
        3. 場上誰最像狼？我的毒藥應該用在誰身上？
        4. 預言家是否還活著？如果死了，我需要接替帶隊嗎？
        """,
        "action_guide": "第一晚通常使用解藥救人。毒藥留給確定的狼人或發言極差的悍跳狼。",
        "voting_guide": "投票策略：(1) 配合預言家歸票 > (2) 如果預言家死亡，你要接替帶隊角色，主動引導投票 > (3) 用毒藥威脅搖擺不定的「牆頭草」。"
    },
    "獵人": {
    ...
    "守衛": {
        ...
        """,
        "phase_guide": {
            "early": "前期隱藏身分，假裝平民。夜晚優先守預言家（如果知道誰是）。第一晚可以選擇守護自己或博弈守預言家。",
            "mid": "繼續隱藏。如果預言家公開跳了身分，後續夜晚優先守預言家。但注意不能連續兩晚守同一人，要和狼人博弈。",
            "late": "殘局可以跳身分報銅水（守護成功記錄）證明自己是好人。這時候你的守護記錄是重要的邏輯證據。"
        },
        "reasoning_guide": """
        分析框架：
        1. 昨晚我守了誰？今晚不能守同一個人。
        2. 場上誰是預言家？誰最需要守護？
        3. 狼人會猜我今晚守誰？我需要做心理博弈。
        4. 場上目前死了誰？如果預言家已經死了，改守女巫或獵人。
        """,
        "action_guide": "優先守護預言家或女巫。記得不能連續兩晚守同一個人。試著和狼人博心態（空守或自守）。",
        "voting_guide": "投票策略：(1) 悄悄跟隨預言家歸票 > (2) 不要發言太突出引起注意 > (3) 殘局時可以跳身分帶票。"
    },
    "白痴": {
